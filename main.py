...
# Константы, используемые в алгоритме SHA-256
K = [
...
def sha256(data: bytes) -> str:
    return generate_hash(data).hex()


# Основная функция для генерации SHA-256 хэша
...
def main():
    transactions = []
    file_names = ["transaction1.txt", "transaction2.txt", "transaction3.txt", "transaction4.txt"]  # Замените названия файлов на нужные
